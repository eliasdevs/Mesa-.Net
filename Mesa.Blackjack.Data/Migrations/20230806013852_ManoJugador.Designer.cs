...
namespace Mesa.Blackjack.Data.Migrations
{
    ...
    [Migration("20230806013852_ManoJugador")]
    partial class ManoJugador
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mesa.Blackjack.Blackjack", b =>
                {
                    ...
                    b.OwnsOne("Mesa_SV.VoDeJuegos.ManoJugadorVo", "UserEmparejado", b1 =>
                        {
                            b1.Property<Guid>("BlackjackId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("BlackjackId");

                            b1.ToTable("Blackjacks");
                            ...
                            b1.OwnsMany("Mesa_SV.VoDeJuegos.Card", "Mano", b2 =>
                                {
                                    b2.Property<Guid>("UserEmparejadoId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("UserEmparejadoId", "Id");

                                    b2.ToTable("BlackJack_Emp_hand", (string)null);

                                    b2.WithOwner()
                                        .HasForeignKey("UserEmparejadoId");
                                });

                            b1.Navigation("Mano");
                        });

                    b.OwnsOne("Mesa_SV.VoDeJuegos.ManoJugadorVo", "UserRetador", b1 =>
                        {
                            b1.Property<Guid>("BlackjackId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("Mesa_SV.VoDeJuegos.Card", "Mano", b2 =>
                                {
                                    ...
                                    b2.ToTable("BlackJack_Ret_hand", (string)null);
                    ...
                    b.Navigation("UserEmparejado")
                        .IsRequired();

                    b.Navigation("UserRetador")
                        .IsRequired();
                });
